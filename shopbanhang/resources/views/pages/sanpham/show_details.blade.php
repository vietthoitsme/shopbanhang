							...
							<div class="tab-pane fade " id="reviews" >
								<div class="col-sm-12">
									<ul>
										...
										<li><a href=""><i class="fa fa-clock-o"></i>12:25 PM</a></li>
										<li><a href=""><i class="fa fa-calendar-o"></i>31 NOV 2021</a></li>
									</ul>
									<p>Giao hàng nhanh, đồ ăn ngon lắm sẽ quay lại ủng hộ shop nhiều</p>
									...
									<form action="#">
										...
										<b>Sao: </b> <img src="{{asset("public/frontend/images/product-details/rating.png")}}" alt="" />
