...
<div class="w3layouts-main">
	...
	?>
		<form action="{{URL::to('/admin-dashboard')}}" method="post">
			...
			<span style="color:black" ><input  type="checkbox" />Nhớ đăng nhập</span>
			<h6><a style="color:black" href="#">Quên mật khẩu</a></h6>
				<div class="clearfix"></div>
				<input  style="color:black" type="submit" value="Đăng nhập" name="login">
		</form>
</div>
</div>
